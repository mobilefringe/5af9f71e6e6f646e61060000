    		...
    		<div class="header page_container">
    			<div class="col-sm-6 text_left no_padding">
    				<router-link to="/" exact>
    					<img class="site-logo" src="//codecloud.cdn.speedyrails.net/sites/5af9f71e6e6f646e61060000/image/png/1526421499700/Mall Logo.png" alt="Eastgate Square">
    				</router-link>
    				<span class="pull-right show_phone">
    					<router-link style="background-color:transparent;" to="/newsletter" ><img src="//codecloud.cdn.speedyrails.net/sites/5af9f71e6e6f646e61060000/image/png/1511797731769/newsletter.png" class="mobile_newsletter_btn" alt="Mobile Newsletter signup icon"></router-link>
    				...
    				<div class="newsletter-div">
    					<div class="newsletter_box" style="margin-bottom:5px">
    						<div class="input_box">
    							...
    							<router-link style="background-color:transparent;" :to="'/newsletter?email='+ newsletter_email" ><img src="//codecloud.cdn.speedyrails.net/sites/5af9f71e6e6f646e61060000/image/png/1511797731769/newsletter.png" alt="Newsletter signup icon"></router-link>
    						</div>
    					</div>
    					<div id="search-form" class="search-form">
    						<div class="input_box">
    							...
    							<img src="//codecloud.cdn.speedyrails.net/sites/5af9f71e6e6f646e61060000/image/png/1514998294110/search_icon.png" id="search_icon" alt="search icon"> 
    						</div>
    				...
    				<div class="mobile_menu_container" v-show="show_mobile_menu">
    					<div class="opened_mobile_menu" >
    						<div class="text-left" style="padding-bottom: 20px;border-bottom: 1px solid #fff;">
    							<img src="//codecloud.cdn.speedyrails.net/sites/5af9f71e6e6f646e61060000/image/png/1513713349903/ES_logo_2.png"  alt="Eastgate Square Mobile Logo">
    		...
    		<div class="menu-div page_container">
    			<div v-for="item in menu_items" :class="item.parent_class_list" style="display: inline-block;padding: 0 20px;">
    				...
    				<div v-else class="all_caps dropdown" :class="{open : item.show_sub_menu}">
    					<a href="#" class="menu_link dropdown-toggle" :id="item.name.id" @click="toggleSubMenu(item.id); item.show_sub_menu = !item.show_sub_menu" data-toggle="dropdown" aria-haspopup="true" :aria-expanded="item.show_sub_menu">{{item.name}} </a>
